...
import by.ksiprus.Personal_Finance_Tools.classifier_service.exceptions.CurrencyAlreadyExistsException;
...
public class CurrencyService implements ICurrencyService {
    ...
    public Currency create(CreateCurrencyRequest request) {
        ...
        if (currencyRepository.existsByTitle(request.getTitle().toUpperCase())) {
            throw new CurrencyAlreadyExistsException("Данная валюта есть в базе");
        }
